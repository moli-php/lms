...
src="http://localhost/image.php?w=183&cr=4:3&image=sample.jpg"
src="http://localhost/image.php?h=200&w=183&image=sample.jpg"
...
define('IMAGE_DIR', "../uploads/photos/");
...
$sImage = IMAGE_DIR . preg_replace('/^(s?f|ht)tps?:\/\/[^\/]+/i', '', (string) $_GET['image']);
