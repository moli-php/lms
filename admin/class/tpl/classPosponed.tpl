<?php echo Common::displayMenu(true,array("label"=>"Schedule Management | Class List","most_action"=>"sameJS.gotoClasslist"));?>
	...
	<table cellpadding="0" cellspacing="0" border="0" class="post_table class_list">
		...
		if(count($posponedInfo)>=1){
			...
			<tr>
				...
				<?php echo ucwords(strtolower($value['classname']));?></td>
