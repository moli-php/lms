	...
	<table cellpadding="0" cellspacing="0" border="0" class="post_table class_list">
		...
		if(count($longTerm)>=1){
			...
			<tr>
				...
				<a href="<?php echo BASE_URL.'admin/class/?action=classManageList&cid='.$value['main_idx'];?>" title="Go to Class Detail Page" ><?php echo ucwords(strtolower($value['classname']));?></a></td>
...
<div class="popup_window class_list_popup" style="display:none;width:350px;padding:0 10px 30px 10px !important" id="add_point" name="add_point">
	<table border="0" cellspacing="0" cellpadding="0" class="table_popup">
	    <tr align="left"><td colspan = 2><b><span class="not_found" name="point_notfound" id="point_notfound"></span></b></td></tr>
        <tr align="left">
            <td>ID <input type="text" readonly maxlength=10 value="" class="fix2 user_id" id="userid_point" name="userid_point" style="width:100px !important;margin-left:10px"/><td>
            <td><a href="javascript:void(0);" class="btn_apply verify_id" id="btn_verify_point" name="btn_verify_point">Verify ID</a></td>
        </tr>
        <tr align="left">
            <td>Choose Class</td>
            <td style="margin:0 0 0 10px;"><select class="search_class select_class" name="select_point"></select></td>
        </tr>
        <tr align="left"><td colspan = 2>Count of rest of Classes : <span class="value" id="rest_class" name="rest_class"></span></td></tr>
        <tr align="left"><td>Point </td><td><input type="text" value="" class="fix2" id="point_check" name="point_check"  style="width:100%;margin-left:10px"/></td></tr>
