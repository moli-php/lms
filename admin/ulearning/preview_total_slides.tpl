...
<head>
	...
	<script type="text/javascript" src="../../js/ulearning/preview_total_slides.js"></script>
</head>
<body>
<div id="wrap">
	<div id="content">
		...
		<ul class="bottom_content">
			...
			<?php if($preview[0]['fexam_type_id'] != 19 && $preview[0]['fexam_type_id'] != 20 && !empty($preview[0]['fsound_file'])){?>
				<object classid="CLSID:6BF52A52-394A-11d3-B153-00C04F79FAA6" type="application/x-shockwave-flash" id="player" width="209" height="46">
					<param name="url" value="../../admin/ulearning/slide_upload/<?=$preview[0]['fsound_file']?>" />
					<param name="src" value="../../admin/ulearning/slide_upload/<?=$preview[0]['fsound_file']?>" />
					<param name="showcontrols" value="true" />
					<param name="autostart" value="false" />
					<!--[if !IE]>-->
					<object type="video/x-ms-wmv"  data="../../admin/ulearning/slide_upload/<?=$preview[0]['fsound_file']?>"  width="209" height="46">
					<param name="src" value="../../admin/ulearning/slide_upload/<?=$preview[0]['fsound_file']?>" />
					<param name="autostart" value="false" />
			...
			<li class="con_4">
				<?php if($offset < $total){?>
				<a href="javascript:preview_total_slides.next_slide(<?php echo $unit_id .','. $offset; ?>)" class="btn"><strong><?php echo $offset .'/'. $total; ?></strong></a>
				<?php }else{?>
