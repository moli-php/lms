<?php echo Common::displayMenu(true,array("label"=>"Send New SMS","most_action"=>"CreateSms"));?>
<!-- hidden -->
...
<input type="hidden" id="fieldset" value="<?php echo isset($aArgs['field']) ?  $aArgs['field']  : "message";?>" />
<input type="hidden" id="orderset" value="<?php echo isset($aArgs['order']) ?  $aArgs['order']  : "asc";?>" />
		...
		<div class="top_2">
    		<div class="apply_action">
    			<a href="#" class="btn_apply" id="deltop">Delete</a>
    		</div>
			<div class="show_rows">
				Show Rows
				<select id="show_row">
		...
		<thead>
			<tr>
				...
				<th>No.</th>
				<th><a href="#" class="sort_down" id="title">Message</a></th>
				<th><a href="#" class="sort_down" id="sent">Sent To</a></th>
				<th><a href="#" class="sort_down" id="reg">Registered Date</a></th>
			</tr>
		</thead>
		<tbody >
		...
		<?php if($listcount>=1){?>
		 <?php foreach ($aData as $list): ?>
			<tr>
				...
				<td><a href="javascript:displayMsg(<?php echo $list['idx']?>);"><?php echo $list['message']?></a></td>
	...
	<div class="bottom">
		<div class="apply_action">
			<a href="#" class="btn_apply" id="delbottom">Delete</a>
		</div>
	</div>
	...
	<div class="message_dialog recordform_dialog" id="sms_msg" style="display:none">

	</div>
	

	
<div class="message_dialog recordform_dialog" id="view_sms" style="display:none;word">
